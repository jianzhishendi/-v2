import{S as H,i as q,s as G,a as _,k as p,q as I,M as L,h as o,c as S,l as y,m as d,r as W,n as u,b as A,G as a,A as C,E as O}from"../../../chunks/index-18ac2d2b.js";import{Y as R}from"../../../chunks/runtime.esm-670b0a78.js";import{A as k}from"../../../chunks/env-e4f9f4f1.js";const $=`<h2>Privacy Policy</h2>
...
`;function M(m){let s,r,e,t,n,P,w,l,b,g,c;return document.title=s=`\r
		Privacy Policy | `+m[0]("title",{default:k})+`\r
	`,{c(){r=_(),e=p("section"),t=p("header"),n=p("h1"),P=I("Privacy Policy for WishSimulator.App"),w=_(),l=p("h2"),b=I("Genshin Impact Wish Simulator"),g=_(),c=p("article"),this.h()},l(i){L('[data-svelte="svelte-avd0f7"]',document.head).forEach(o),r=S(i),e=y(i,"SECTION",{class:!0});var v=d(e);t=y(v,"HEADER",{class:!0});var f=d(t);n=y(f,"H1",{class:!0});var T=d(n);P=W(T,"Privacy Policy for WishSimulator.App"),T.forEach(o),w=S(f),l=y(f,"H2",{class:!0});var E=d(l);b=W(E,"Genshin Impact Wish Simulator"),E.forEach(o),f.forEach(o),g=S(v),c=y(v,"ARTICLE",{class:!0});var x=d(c);x.forEach(o),v.forEach(o),this.h()},h(){u(n,"class","svelte-1b38fyb"),u(l,"class","svelte-1b38fyb"),u(t,"class","svelte-1b38fyb"),u(c,"class","svelte-1b38fyb"),u(e,"class","svelte-1b38fyb")},m(i,h){A(i,r,h),A(i,e,h),a(e,t),a(t,n),a(n,P),a(t,w),a(t,l),a(l,b),a(e,g),a(e,c),c.innerHTML=$},p(i,[h]){h&1&&s!==(s=`\r
		Privacy Policy | `+i[0]("title",{default:k})+`\r
	`)&&(document.title=s)},i:C,o:C,d(i){i&&o(r),i&&o(e)}}}function N(m,s,r){let e;return O(m,R,t=>r(0,e=t)),[e]}class F extends H{constructor(s){super(),q(this,s,N,M,G,{})}}export{F as default};
